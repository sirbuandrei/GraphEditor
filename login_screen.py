...
from main import MainWindow # Assuming MainWindow is in main.py
...
class LoginScreen(QMainWindow):
    ...
    def handle_login(self):
        ...
        if not FIREBASE_WEB_API_KEY or FIREBASE_WEB_API_KEY == "YOUR_FIREBASE_WEB_API_KEY":
            ...
            print("Error: FIREBASE_WEB_API_KEY is not configured in login_screen.py. Please replace 'YOUR_FIREBASE_WEB_API_KEY' with your actual key.")
            return
        ...
        try:
            ...
            print(f"Error decoding JSON response from Firebase. Status: {response.status_code}, Response text: {response.text}")
