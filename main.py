...
from PyQt5.QtCore import (Qt, QEvent, QTimer, QSequentialAnimationGroup)
from PyQt5.QtWidgets import (QMainWindow, QGraphicsDropShadowEffect, QApplication, QDialog)
...
if __name__ == "__main__":
    ...
    presenter = LoginPresenter(login_screen, user, on_login_success=show_main_screen)
